...
#   key_permissions = [
#     "Create", "Get", "Delete", "Purge", "GetRotationPolicy", "Delete", "Purge"
#   ]
...
#   source = "./synapse_workspace_with_Local_n_entraID"
#   #naming convention
#   Clientname       = "Hayago"
#   workload         = "Synapse"
#   environment_type = "dev"
...
#   sql_administrator_login          = "azureusesr"
...
#   double_encryption_key_name           = "DoubleEncryptionKey"
...
#   start_ip_address             = "58.26.84.6"
#   end_ip_address               = "58.26.84.6"


#   #generated random passwork will be stored in keyvault
#   keyvault_id_to_store = module.keyvault_for_double_encryption.key_vault_id

# }


# #synapse workspace permission to get, wrapkey, unwrapky
# #including lifecycle to delete/rotate the key
...
# #configure  add_admin/ ad_sql admin (need to test)
