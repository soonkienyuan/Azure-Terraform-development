...
#   Client_name              = local.storage_account.sa_basic_tab.client_name
...
#   enable_microsof_managed_encryption = local.storage_account.sa_security.enable_microsof_managed_encryption
#   key_vault_key_id                   = local.storage_account.sa_security.key_vault_key_id
# }
...
#   key_permissions = [
#     "Create", "Get", "Delete", "Purge", "GetRotationPolicy", "Delete"
#   ]
...
#   start_ip_address             = "60.52.55.44"
#   end_ip_address               = "60.52.55.44"
...
#   depends_on = [module.synapse_Local_n_entraID]
# }
...
#   active                              = true
#   customer_managed_key_name           = "DoubleEncryptionKey"
#   depends_on                          = [azurerm_key_vault_access_policy.workspace_policy, module.synapse_Local_n_entraID]
# }
...
# resource "azurecaf_name" "synapse_managed_private_endpoint" {
#   name          = "mpe"
#   resource_type = "general_safe"
#   suffixes      = ["hayago", "wp001", "Blob", "dev", "sea", "001"]
#   clean_input   = true
# }


# #blob storage pv endpoint

# resource "azurerm_synapse_managed_private_endpoint" "blob_endpoint" {
#   #defining name 
#   name                 = azurecaf_name.synapse_managed_private_endpoint.result
#   synapse_workspace_id = module.synapse_Local_n_entraID.synapse_workspace_id
#   target_resource_id   = module.storage_for_synapse.id_storage_account
#   subresource_name     = "blob"
#   depends_on           = [module.synapse_Local_n_entraID, module.storage_for_synapse]
# }
